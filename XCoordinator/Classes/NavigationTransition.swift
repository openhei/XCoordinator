...
extension Transition where RootViewController: UINavigationController {
    ...
    public static func pop(to presentable: Presentable, animation: Animation? = nil) -> Transition {
        return Transition(presentables: [presentable], animation: animation?.dismissalAnimation) { options, performer, completion in
            performer.pop(
    ...
    public static func set(_ presentables: [Presentable], animation: Animation? = nil) -> Transition {
        return Transition(presentables: presentables, animation: animation?.presentationAnimation) { options, performer, completion in
            performer.set(
