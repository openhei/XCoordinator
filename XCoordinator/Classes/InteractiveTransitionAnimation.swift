...
open class InteractiveTransitionAnimation: NSObject, TransitionAnimation {
    ...
    ///
    public init(duration: TimeInterval, transition: @escaping (_ context: UIViewControllerContextTransitioning) -> Void, generateInteractionController: @escaping () -> PercentDrivenInteractionController?) {
    ...
    ///     The context in which the transition is performed.
    ///
    public convenience init(duration: TimeInterval, transition: @escaping (_ context: UIViewControllerContextTransitioning) -> Void) {
        self.init(
            duration: duration,
